...
Version 1.0.2 is distributed directly from GitHub as a notarized, signed DMG
...
Scripts/notarize-release.sh finish \
  dist/HS-Reconnect-1.0.2.dmg SUBMISSION_ID
```
...
```sh
Scripts/verify-release.sh dist/HS-Reconnect-1.0.2.dmg
```

Only the verified, stapled DMG is attached to the GitHub v1.0.2 release. GitHub
